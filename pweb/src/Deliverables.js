  ...
  return (
    <div className="deliverables-container">
      ...
      <div className="deliverable">
        ...
        <a href={`${process.env.PUBLIC_URL}/Metals-Sprint3_SprintPlanningDocument.doc`} target="_blank" rel="noopener noreferrer" className="github-button">
          Sprint 3 Planning Document
        </a>
        <a href={`${process.env.PUBLIC_URL}/Metals-Sprint3_SprintGoalBacklog.doc`} target="_blank" rel="noopener noreferrer" className="github-button">
          Sprint 3 Backlog
        </a>
        <a href={`${process.env.PUBLIC_URL}/DailyJournalDocument.pdf`} target="_blank" rel="noopener noreferrer" className="github-button">
          Updated Daily Journal
        ...
        <a href={`${process.env.PUBLIC_URL}/Metals-Sprint3_ReviewandRetro.doc`} target="_blank" rel="noopener noreferrer" className="github-button">
          Sprint 3 Retrospective
        </a>
        <a href={`${process.env.PUBLIC_URL}/Metals-Sprint3_ProjectBacklog.xlsx`} target="_blank" rel="noopener noreferrer" className="github-button">
          Project Backlog
        </a>
        <a href="https://github.com/JCstumper/Guaranty_Sheet_Metal/tree/sprint1snapshot" className="github-button">
